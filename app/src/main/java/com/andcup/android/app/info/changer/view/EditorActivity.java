...
import com.andcup.android.framework.RxAppCompatActivity;
import com.andcup.android.framework.tools.FragmentJumper;
import com.chrisplus.rootmanager.RootManager;

import butterknife.Bind;

public class EditorActivity extends RxAppCompatActivity
    ...
    protected void afterActivityCreate(Bundle savedInstanceState) {
        ...
        FragmentJumper jumper = new FragmentJumper(getSupportFragmentManager());
        jumper.at(R.id.fr_container).to(EditorFragment.class).go();
